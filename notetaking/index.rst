...
に行けばこれまでなかったボタンが現れているはずです. ボタンを押し, 修正に関する
コメントを書いた上でプルリクエストを発行してください. メンテナーに通知され,
コードレビューの後に問題がなければ upstream が更新 (マージ) されるでしょう.
問題があれば, GitHub 上でディスカッションを行い, マージ可能なレベルに達するまで
必要な修正を施します.
