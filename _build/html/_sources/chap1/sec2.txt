...
詳しくは, `公式のreStructuredText入門 <http://docs.sphinx-users.jp/rest.html>`_ か，
`Sphinxでドキュメントを書くためreST記法に入門した <http://d.hatena.ne.jp/kk_Ataka/20111202/1322839748>`_ を参照するといいと思います．
...
参考にしたのは，`Sphinxの公式サイトのチュートリアル <http://docs.sphinx-users.jp/rest.html>`_
でズバリそのものが書いてある．
...
この勉強会の教科書になっている，Quantitive EconomicのSolutionや，
Libraryをつくるプロジェクトも `GitHubで公開 <https://github.com/QuantEcon/QuantEcon.py>`_
されています．

そして，そもそもこの勉強会の資料なども，`Githubで公開してます <https://github.com/rokkopy/qe-seminar>`_．
